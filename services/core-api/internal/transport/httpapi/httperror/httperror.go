// Package httperror owns the contract every response outside the success path
// follows: the body, the public code and the status a handler error resolves to.
package httperror
